...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: const Bottom(index: 0),
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text("Mehr", style: Theme.of(context).textTheme.bodyLarge!),
            ],
          ),
          const SizedBox(
            height: 20,
                    ...
                    child: InkWell(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                              'vor ${DateTime.now().difference(articles[index].createdAt).inHours} Stunden veröffentlicht',
